...
import com.java.backend.BookcarApp;
import com.java.backend.config.AsyncSyncConfiguration;
import com.java.backend.config.EmbeddedMongo;
...
@SpringBootTest(classes = { BookcarApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
